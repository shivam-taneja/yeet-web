        ...
        <div className="prose prose-lg prose-ink max-w-none">
          ...
          <section className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 text-ink/80 space-y-2 mt-4">
                ...
                <li>
                  ...
                  includes the draft you just sent and the direct URL to your
            ...
            <div>
              ...
              <p className="text-ink/80 mt-4">
                Opening X or Threads compose URLs happens locally in your
                browser, as you. Yeet does not proxy those posts through our
                servers. When an automatic cross-post is completed, Yeet will
                briefly intercept the local network response generated by your
                browser to find the URL of your new post (so it can be displayed
                in the extension popup), but this data never leaves your device.
              </p>
            </div>
